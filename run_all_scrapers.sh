...
xvfb-run python3 scripts/manhwa_scraper.py --site asura --download-all -i asura.yaml

echo "=== Flame Comics ==="
xvfb-run python3 scripts/manhwa_scraper.py --site flame --list-all -o flame.yaml && \
xvfb-run python3 scripts/manhwa_scraper.py --site flame --download-all -i flame.yaml

echo "=== Drake Comics ==="
xvfb-run python3 scripts/manhwa_scraper.py --site drake --list-all -o drake.yaml && \
xvfb-run python3 scripts/manhwa_scraper.py --site drake --download-all -i drake.yaml
...
# xvfb-run python3 scripts/manhwa_scraper.py --site manhuato --download-all -i manhuato.yaml

echo "=== Webtoon ==="
xvfb-run python3 scripts/manhwa_scraper.py --site webtoon --list-all -o webtoon.yaml && \
xvfb-run python3 scripts/manhwa_scraper.py --site webtoon --download-all -i webtoon.yaml
